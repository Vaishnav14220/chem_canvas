import './quizletFlashcards.css';
import type { CSSProperties } from 'react';
import { useFlashcardArray } from './useFlashcardArray';
import Flashcard from './Flashcard';
import type { IFlashcard } from './types';
import type { UseFlashcardArray } from './useFlashcardArray';
    ...
    >
      ...
      >
        ...
        <Flashcard
          ...
          back={deck[localFlipArrayHook.cardsInDisplay[1]]?.back ?? { html: <></> }}
          front={deck[localFlipArrayHook.cardsInDisplay[1]]?.front ?? { html: <></> }}
