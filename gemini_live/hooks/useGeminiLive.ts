...
import { getGeminiApiKey } from '../services/firebaseApiKeyService';
...
export const useGeminiLive = () => {
  ...
  const connect = useCallback(async () => {
    ...
    if (!API_KEY) {
      setError("No Gemini API key found in Firestore. Please configure an API key in the 'apikey' collection.");
      return;
    }
